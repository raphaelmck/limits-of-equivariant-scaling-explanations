...
(compute, normalized force MSE) table; common/force_scaling_fit.py implements the fit.
...
from common.force_scaling_fit import build_frontier, common_interval, fit_loglog, truncate_upper
    ...
    for a in prim_arches:
        ...
        out_rows.append({
            ...
            "source_file": "recomputed from data/claim1/four_arch_force_checkpoint_table.csv "
                            "via common/force_scaling_fit.py",
        })
    return out_rows
