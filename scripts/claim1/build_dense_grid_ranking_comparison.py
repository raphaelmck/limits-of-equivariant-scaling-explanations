...
Same learning-curve-area statistic (src/krr_auc.py), same ascending-rank convention, same
training sizes {32, 64, 128, 256, 512}, ridgeless curves against the common force target.

Inputs, all in data/claim1/:
  owner_manifest.csv                      normalized force MSE, LOW/MID/HIGH
  dense_grid_owner_force_mse.csv          normalized force MSE, the five added budgets
...
def build() -> list[dict]:
    ...
    dense_owners = read_csv(data_path("claim1", "dense_grid_owner_force_mse.csv"))
