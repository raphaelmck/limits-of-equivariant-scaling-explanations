"""CSV/JSON/JSONL loading helpers, and the only sanctioned way to build a path into data/ or
analysis_out/.

No path constructed in code/analysis/ may point outside this repository: every number in
