# code/analysis/claim1/ — kernel and scaling tables

Entry points that load `data/claim1/`, call `code/analysis/common/`, and write to
`analysis_out/claim1/`. They read only from this repository.
...
Run via `make analysis`, or invoke one directly with `python3 code/analysis/claim1/<script>.py`.
