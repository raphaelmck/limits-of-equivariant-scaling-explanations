...
def paired_config_bootstrap(
    ...
    rng: an existing numpy.random.RandomState to draw from (advances its state) -- pass this
      ...
      code/analysis/claim1/build_dense_grid_pairwise_gap.py, which threads one RandomState across
...
def bootstrap_paired_log_ratio_ci(
    ...
    (code/analysis/claim1/build_dense_grid_pairwise_gap.py) is responsible for creating a single shared
