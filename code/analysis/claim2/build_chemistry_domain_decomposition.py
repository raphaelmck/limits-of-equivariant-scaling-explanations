...
as data/claim2/chemistry_domain_labels.json. Their per-family counts (electrolytes 10867, biomolecules
...
Writes into analysis_out/claim2/:
  chemistry_domain_decomposition.csv
  chemistry_family_positive_control.csv
"""
...
def main():
    ...
    labels = read_json(data_path("claim2", "chemistry_domain_labels.json"))
    ...
    write_csv(out_path("claim2", "chemistry_domain_decomposition.csv"), strata_rows)
    ...
    write_csv(out_path("claim2", "chemistry_family_positive_control.csv"), contrast_rows)

    print("wrote chemistry_domain_decomposition.csv, chemistry_family_positive_control.csv")
