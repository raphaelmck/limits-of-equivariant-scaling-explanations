...
def load_canonical_4():
    ...
    matched_compute_lmax2_vs_lmax4_baseline.csv / lmax2_vs_lmax4_baseline.csv, unchanged.)"""
    rows = list(csv.DictReader(open(PAPER_REPRO / "data" / "claim2" / "matched_compute_lmax2_vs_lmax4_baseline.csv")))
...
def main():
    ...
    # already-published H_force/CI from matched_compute_lmax2_vs_lmax4_baseline.csv (M=16384) to sanity-check
