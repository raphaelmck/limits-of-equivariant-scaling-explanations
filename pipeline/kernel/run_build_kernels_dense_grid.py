...
not in `owner_manifest.csv`). No numerics/provenance logic is reimplemented -- same imported
...
# check_owner_provenance in the 2026-08-22 script reads owner_manifest.csv rows, but sourced from
# this module's own OWNERS_RAW_DENSE23 (there is no owner_manifest.csv row for a _dense23 tag).
_RAW_BY_TAG = {}
...
def check_owner_provenance_dense23(owner: OwnerSpec) -> dict[str, Any]:
    ...
    own literal (architecture,width,step,ckpt_path) tuple instead of owner_manifest.csv (these
