...
used in Figure 2A. common/seed_replication.py exists as a separate module to keep the two apart.
...
from common.io_utils import data_path, out_path, read_jsonl, write_json
from common.seed_replication import (
    ALPHAS,
    BOOTSTRAP_SEED,
    N_BOOT,
    P_STAR,
